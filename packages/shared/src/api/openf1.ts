...
export async function getMeetings(year?: number) {
  ...
  return fetchJson<import("@f1-dashboard/shared/types/api").Meeting[]>(`/meetings${q}`);
}

export async function getMeeting(meetingKey: number) {
  const q = buildQuery({ meeting_key: meetingKey });
  const results = await fetchJson<import("@f1-dashboard/shared/types/api").Meeting[]>(
    `/meetings${q}`,
  );
...
export async function getSessions(meetingKey?: number, year?: number) {
  ...
  return fetchJson<import("@f1-dashboard/shared/types/api").Session[]>(`/sessions${q}`);
}

export async function getSession(sessionKey: number) {
  const results = await fetchJson<import("@f1-dashboard/shared/types/api").Session[]>(
...
export async function getSessionResults(meetingKey: number, sessionKey?: number) {
  ...
  return fetchJson<import("@f1-dashboard/shared/types/api").SessionResult[]>(`/session_result${q}`);
}

// Starting Grid
export async function getStartingGrid(meetingKey: number, sessionKey?: number) {
  const q = buildQuery({ meeting_key: meetingKey, session_key: sessionKey });
  return fetchJson<import("@f1-dashboard/shared/types/api").SessionResult[]>(`/starting_grid${q}`);
}
...
export async function getDrivers(sessionKey?: number, meetingKey?: number) {
  ...
  return fetchJson<import("@f1-dashboard/shared/types/api").Driver[]>(`/drivers${q}`);
}
...
export async function getLaps(sessionKey: number, driverNumber?: number) {
  ...
  return fetchJson<import("@f1-dashboard/shared/types/api").Lap[]>(`/laps${q}`);
}

// Position
export async function getPositions(sessionKey: number) {
  return fetchJson<import("@f1-dashboard/shared/types/api").Position[]>(
...
export async function getIntervals(sessionKey: number) {
  return fetchJson<import("@f1-dashboard/shared/types/api").Interval[]>(
...
export async function getCarData(sessionKey: number, driverNumber?: number) {
  const q = buildQuery({ session_key: sessionKey, driver_number: driverNumber });
  return fetchJson<import("@f1-dashboard/shared/types/api").CarData[]>(`/car_data${q}`);
}

// Pit Stops
export async function getPitStops(sessionKey: number) {
  return fetchJson<import("@f1-dashboard/shared/types/api").PitStop[]>(
...
export async function getStints(sessionKey: number) {
  return fetchJson<import("@f1-dashboard/shared/types/api").Stint[]>(
...
export async function getWeather(sessionKey: number) {
  return fetchJson<import("@f1-dashboard/shared/types/api").WeatherReading[]>(
...
export async function getRaceControl(sessionKey: number) {
  return fetchJson<import("@f1-dashboard/shared/types/api").RaceControlMessage[]>(
...
export async function getChampionshipDrivers(sessionKey?: number) {
  ...
  return fetchJson<import("@f1-dashboard/shared/types/api").ChampionshipDriver[]>(
    `/championship_drivers${q}`,
  );
}
...
export async function getLocation(sessionKey: number, driverNumber?: number) {
  const q = buildQuery({ session_key: sessionKey, driver_number: driverNumber });
  return fetchJson<import("@f1-dashboard/shared/types/api").Location[]>(`/location${q}`);
}

// Team Radio
export async function getTeamRadio(sessionKey: number) {
  return fetchJson<import("@f1-dashboard/shared/types/api").TeamRadioEntry[]>(
...
export async function getOvertakes(sessionKey: number) {
  return fetchJson<import("@f1-dashboard/shared/types/api").Overtake[]>(
