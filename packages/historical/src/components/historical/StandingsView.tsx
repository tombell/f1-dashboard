import { getSessionResults, getSessions, getDrivers } from "@f1-dashboard/shared/api/openf1";
import type { Meeting, SessionResult } from "@f1-dashboard/shared/types/api";
...
async function loadMeeting(mk: number): Promise<LoadResult> {
  try {
    ...
    const driverPromises: Promise<import("@f1-dashboard/shared/types/api").Driver[]>[] = [];
