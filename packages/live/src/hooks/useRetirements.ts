import { STALE_RETIRE, STALE_ACTIVE } from "@f1-dashboard/shared/constants/f1";
import type { Driver, Position, RaceControlMessage, Stint } from "@f1-dashboard/shared/types/api";
